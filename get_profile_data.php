...
function p_setsql($sqlc)
{
    $GLOBALS['sql']=$sqlc;
    
}
   
function p_getdata($conn)
{ 
    $i=0;
    ...
    { 
     ...
     //   echo "working.<br>" ;
        ...
        $_SESSION['ta_aid']=$row['a_qid'];              //7
         $qid=$row['a_qid'];
       $qlinksql="select * from user_info.q_bank where qid='$qid';";
           
        $qlinkresult=$conn->query($qlinksql);
        $qlinkrow=$qlinkresult->fetch_assoc();
        ...
        $_SESSION['q_text']=$qlinkrow['q_text'];        //13
       
       $_SESSION['tq_text']=str_replace("\n","<br>",$_SESSION['tq_text']) ;
       $data_set[$i]=array($_SESSION['tfname'],$_SESSION['tlname'],$_SESSION['ta_date_text'],$_SESSION['ta_subject'],$_SESSION['ta_topic'],$_SESSION['ta_exam'],$_SESSION['ta_text'],$_SESSION['ta_aid'],$_SESSION['ta_date'],$_SESSION['taid'],$_SESSION['ta_certify'],$_SESSION['ta_img'],$_SESSION['ta_img_type'],$_SESSION['q_text']);
        $i++;
