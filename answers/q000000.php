...
echo "anwsers/q1911290";



$_SESSION['this_file']=$_SESSION['cur_file'];
echo $_SESSION['this_file'];
...
<body> 
   ...
   <div class="head_type">Active Users</div>
        ...
        <div class="user_tab_name" style="color:<?php echo $pair_color_pack[$user_data_set[$i][3]][0]; ?>">
         <?php  echo $user_data_set[$i][0]." ".$user_data_set[$i][1] ?>
      ...
      <?php 
        ...
        ?>  
           <a href="feedback.php" target="_blank"><div class="user_tab" style="margin-top:500px;background-color:#0CB566;">
...
$_SESSION['t_exam']=$data_set[$i][5];
            ...
            // $real_text=str_replace("\n","<br>",$data_set[$i][6]);
                 // $qreal_text=str_replace("<","&#60;",$data_set[$i][6]);
           echo $data_set[$i][6];
       // echo $real_text;  ?>
            </div>
            <script>
...
//******update each visit********//
        ...
        $_SESSION['cur_file']=$_SESSION['cur_file']."?qid=".$vqid;
...
$text = preg_replace('#><#', ">\n<", $text); */
       ...
       // echo $real_text;
            ...
            <?php } ?>
           <?php  $addr="uploads/".$data_set[$i][11].".".$data_set[$i][12];
            if(file_exists($addr))  { ?>
      
        <div class="a_image">
            
            <?php if($data_set[$i][12]==NULL) { ?>
            <img draggable="false" width="700px" src="uploads/<?php echo $data_set[$i][11].".jpg" ;?>" alt="<?php echo $data_set[$i][11].".jpg" ;?>">
            <?php } else { ?>
         
            <img width="700px" draggable="false" src="uploads/<?php echo $data_set[$i][11].".".$data_set[$i][12] ;?>" alt="<?php echo $data_set[$i][11];?>">
            <?php } ?>
...
{?>
    ...
    <?php $_SESSION['qid']=$vqid; ?>
        ...
        <div class="text_box">
<form action="b_upload_answer.php?qid=<?php echo $vqid; ?>" method="post" enctype="multipart/form-data">
